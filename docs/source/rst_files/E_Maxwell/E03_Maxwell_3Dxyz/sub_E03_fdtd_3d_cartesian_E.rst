sub_E03_fdtd_3d_cartesian_E.f90
--------------------------------
...
.. container:: ap-lang ap-lang-zh
   ...
   在三维 Cartesian Yee 网格上，用 ``Hx/Hy/Hz`` 的 curl 更新 ``Ex/Ey/Ez``。
   ...
   - 三个嵌套循环内按 Yee curl 逐点原地更新 ``Ex``、``Ey``、``Ez``。
   - 每个分量只读磁场相邻点和旧电场值，不分配临时大数组。
...
.. container:: ap-lang ap-lang-en
   ...
   Updates ``Ex/Ey/Ez`` from the curl of ``Hx/Hy/Hz`` on a 3D Cartesian Yee grid.
   ...
   - Updates ``Ex``, ``Ey``, and ``Ez`` in place with standard Yee curl loops.
   - Each component reads neighboring magnetic-field values and the old electric-field value without allocating a large temporary array.
   ...
   .. doxygenfile:: sub_E03_fdtd_3d_cartesian_E.f90
