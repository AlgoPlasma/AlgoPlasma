mod_E02_fdtd_3d_cylindrical.f90
--------------------------------
...
.. container:: ap-lang ap-lang-zh
   ...
   这个 module wrapper 汇入三维柱坐标六分量 FDTD 的电场和磁场更新核。
   ...
   .. list-table::
      ...
      * - 入口 / 文件
        - 角色
        - 关系
      * - ``sub_E02_fdtd_3d_cylindrical_H``
        - 磁场更新入口。
        - 由 Fortran 预处理 ``#include`` 汇入 module。
      * - ``sub_E02_fdtd_3d_cylindrical_E``
        - 电场更新入口。
        - 由 Fortran 预处理 ``#include`` 汇入 module。

   .. rubric:: 局部假设

   - 模块面向 3D 柱坐标 ``r-phi-z`` Yee 场。
...
.. container:: ap-lang ap-lang-en
   ...
   This module wrapper includes electric and magnetic six-component FDTD update kernels in cylindrical coordinates.
   ...
   .. list-table::
      ...
      * - Entry / File
        ...
        - Relation
      * - ``sub_E02_fdtd_3d_cylindrical_H``
        - Magnetic-field update entry.
        - Included into the module by the Fortran preprocessor.
      * - ``sub_E02_fdtd_3d_cylindrical_E``
        - Electric-field update entry.
        - Included into the module by the Fortran preprocessor.

   .. rubric:: Local Assumptions

   - The module targets 3D cylindrical ``r-phi-z`` Yee fields.
   ...
   .. doxygenfile:: mod_E02_fdtd_3d_cylindrical.f90
