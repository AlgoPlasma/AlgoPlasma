...
.. container:: ap-lang ap-lang-zh
   ...
   ``sub_D04_hypre_3Draz_nonuniform_bc_A_outflow`` 在已组装矩阵/RHS 上加入 outflow/Robin 类型边界修正。
...
.. container:: ap-lang ap-lang-en
   ...
   ``sub_D04_hypre_3Draz_nonuniform_bc_A_outflow`` apply outflow/Robin-type boundary corrections to the already assembled 7-point matrix and RHS for the single-domain 3D cylindrical nonuniform Poisson equation on a cell-centered grid.
   ...
   .. list-table::
      ...
      * - ``dr``
        - in
        - scalar or caller-provided array
        - real (il(1):iu(1)), radial cell widths.
      * - ``da``
        - in
        - scalar or caller-provided array
        - real (il(2):iu(2)), azimuthal cell widths.
      * - ``dz``
        - in
        - scalar or caller-provided array
        - real (il(3):iu(3)), axial cell widths.
      * - ``bc_type``
        - in
        - ``(1:6)``
   ...
   .. doxygenfile:: sub_D04_hypre_3Draz_nonuniform_bc_A_outflow.f90
