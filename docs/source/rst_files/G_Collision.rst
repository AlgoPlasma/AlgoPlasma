...
.. container:: ap-lang ap-lang-zh
   ...
   - ``tests/009_collision`` 当前覆盖截面表加载器的数组边界行为；它不验证完整 MCC 物理过程。
...
.. container:: ap-lang ap-lang-en
   ...
   - ``tests/009_collision`` covers array-bound behavior in the cross-section loader; it is not a complete MCC physics validation.
