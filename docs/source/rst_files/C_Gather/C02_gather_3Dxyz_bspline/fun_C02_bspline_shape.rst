...
.. container:: ap-lang ap-lang-zh
   ...
   ``fun_C02_bspline_shape`` 计算中心化 B-spline 形函数
   ``S_order(r)``。它只负责一个距离 ``r`` 上的权重值，完整 gather 推导见
   ...
   .. code-block:: fortran
      ...
      value = fun_C02_bspline_shape(order,r)
...
.. container:: ap-lang ap-lang-en
   ...
   ``fun_C02_bspline_shape`` evaluates the centered B-spline shape function
   ...
   .. doxygenfile:: fun_C02_bspline_shape.f90
