...
.. container:: ap-lang ap-lang-zh
   ...
   ``sub_F04_field_output_3d_grid_bin`` 将一维或三维场数组 ``F`` 按调用方给定的索引范围写入文件。
...
.. container:: ap-lang ap-lang-en
   ...
   ``sub_F04_field_output_3d_grid_bin`` output a cell-centered 3D field reconstructed from a grid-defined array to per-rank binary files.
   ...
   .. list-table::
      ...
      * - ``F``
        - in
        - field array on caller index range
        - real (il(1)-1:iu(1),il(2)-1:iu(2),il(3)-1:iu(3)), grid-defined field.
   ...
   .. doxygenfile:: sub_F04_field_output_3d_grid_bin.f90
