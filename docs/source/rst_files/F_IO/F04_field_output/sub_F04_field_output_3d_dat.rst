...
.. container:: ap-lang ap-lang-zh
   ...
   ``sub_F04_field_output_3d_dat`` 将一维或三维场数组 ``F`` 按调用方给定的索引范围写入文件。
...
.. container:: ap-lang ap-lang-en
   ...
   ``sub_F04_field_output_3d_dat`` output a 3D cell-centered field to per-rank ASCII files.
   ...
   .. doxygenfile:: sub_F04_field_output_3d_dat.f90
