...
.. container:: ap-lang ap-lang-zh
   ...
   ``sub_F04_field_output_3d_bin`` 将一维或三维场数组 ``F`` 按调用方给定的索引范围写入文件。
...
.. container:: ap-lang ap-lang-en
   ...
   ``sub_F04_field_output_3d_bin`` output a 3D cell-centered field to per-rank binary files.
   ...
   .. list-table::
      ...
      * - ``F``
        - in
        - field array on caller index range
        - real (il(1):iu(1),il(2):iu(2),il(3):iu(3)), 3D field.
   ...
   .. doxygenfile:: sub_F04_field_output_3d_bin.f90
