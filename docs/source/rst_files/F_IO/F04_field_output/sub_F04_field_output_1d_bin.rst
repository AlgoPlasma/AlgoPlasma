...
.. container:: ap-lang ap-lang-zh
   ...
   ``sub_F04_field_output_1d_bin`` 将一维或三维场数组 ``F`` 按调用方给定的索引范围写入文件。
...
.. container:: ap-lang ap-lang-en
   ...
   ``sub_F04_field_output_1d_bin`` output a 3D cell-centered field stored as a 1D array to a binary stream file.
   ...
   .. list-table::
      ...
      * - ``F``
        - in
        - ``(1:N)``
        - real (1:N), 1D field vector with ``N = nx*ny*nz``.
   ...
   .. doxygenfile:: sub_F04_field_output_1d_bin.f90
