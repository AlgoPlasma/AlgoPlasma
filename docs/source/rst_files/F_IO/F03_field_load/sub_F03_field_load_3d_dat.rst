...
.. container:: ap-lang ap-lang-zh
   ...
   ``sub_F03_field_load_3d_dat`` 从文件读取一维或三维场数组 ``F`` 到调用方给定的索引范围。
...
.. container:: ap-lang ap-lang-en
   ...
   ``sub_F03_field_load_3d_dat`` load a 3D cell-centered field from per-rank ASCII files.
   ...
   .. doxygenfile:: sub_F03_field_load_3d_dat.f90
