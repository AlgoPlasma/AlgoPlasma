...
.. container:: ap-lang ap-lang-zh
   ...
   ``sub_F03_field_load_1d_bin`` 从文件读取一维或三维场数组 ``F`` 到调用方给定的索引范围。
...
.. container:: ap-lang ap-lang-en
   ...
   ``sub_F03_field_load_1d_bin`` load a 3D cell-centered field stored as a 1D vector from per-rank binary files.
   ...
   .. list-table::
      ...
      * - ``F``
        - out
        - ``(1:N)``
        - real, allocatable (1:N), 1D field vector read from file.
   ...
   .. doxygenfile:: sub_F03_field_load_1d_bin.f90
