...
HYPRE_INC=${HYPRE_INC:-/home/wbs/install/hypre/src/hypre/include}
HYPRE_LIB=${HYPRE_LIB:-/home/wbs/install/hypre/src/hypre/lib}
D01_DIR=../../../D_Poisson/D01_hypre_3Dxyz

FC=mpif90
CC=mpicc
HYPRE_SRC=${HYPRE_SRC:-/home/wbs/install/hypre/src}
