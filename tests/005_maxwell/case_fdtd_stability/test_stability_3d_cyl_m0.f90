program test_stability_3d_cyl_m0
    ...
    write(*,'(A)') '=== Stability Test: 3D cylindrical m=0 (no source, long run) ==='
    ...
    write(*,'("SUMMARY_CSV,3D_CYL_M0,",F5.3,",",I0,",",1PE12.4,",",1PE12.4,",",1PE12.4,",",A)') &
...
contains
    ...
    subroutine fill_e_boundaries(nr,nphi,nz,Er,Ephi,Ez)
        ...
        call fill_outer_r_copy(nr,nphi,nz,Ephi)
...
end program test_stability_3d_cyl_m0
