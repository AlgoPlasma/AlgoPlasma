program test_pulse_3d_cyl_m0
    ...
    write(*,'(A)') '=== Pulse Long-Run Stability: 3D cylindrical m=0 ==='
    ...
    write(*,'("SUMMARY_CSV,3D_CYL_M0,",F5.3,",",I0,",",I0,",",1PE12.4,",",1PE12.4,",",A)') &
...
end program test_pulse_3d_cyl_m0
