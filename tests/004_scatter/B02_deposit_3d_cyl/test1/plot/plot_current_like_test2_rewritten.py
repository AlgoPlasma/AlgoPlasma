...
def main():
    p_jr = Path('current_jr_map.dat')
    p_jphi = Path('current_jphi_map.dat')
    p_jz = Path('current_jz_map.dat')
    p_err = Path('current_error_map.dat')
    ...
    fig.tight_layout()
    fig.savefig('current_paper_like_test2_rewritten.png', dpi=200)
    print('Saved current_paper_like_test2_rewritten.png')
