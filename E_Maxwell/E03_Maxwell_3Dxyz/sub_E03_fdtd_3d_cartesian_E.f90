!> @file sub_E03_fdtd_3d_cartesian_E.f90
!> @brief Updates Cartesian electric fields ``Ex``, ``Ey``, and ``Ez``.
!> @details This routine advances the electric fields with standard
...
!> @param[in,out] Ex: real 3D array, ``x`` electric field component.
!> @param[in,out] Ey: real 3D array, ``y`` electric field component.
!> @param[in,out] Ez: real 3D array, ``z`` electric field component.
!> @param[in] Hx: real 3D array, ``x`` magnetic field component.
!> @param[in] Hy: real 3D array, ``y`` magnetic field component.
!> @param[in] Hz: real 3D array, ``z`` magnetic field component.
...
subroutine sub_E03_fdtd_3d_cartesian_E(ilo_f,ihi_f,jlo_f,jhi_f,klo_f,khi_f, &
...
end subroutine sub_E03_fdtd_3d_cartesian_E
